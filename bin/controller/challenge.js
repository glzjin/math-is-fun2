...
Thanks to the challenge team for submitting this vulnerability to us in a timely manner. Now we have fixed this problem, you can use it with confidence.
</textarea>
                </div>
        ...
        try {
            ...
            search.text ? $("textarea")[0].value = 'hello '+ config['name'] + ":\\n\\n" + search.text : undefined;
        }
        catch(e) {
            console.log(e);
        }
